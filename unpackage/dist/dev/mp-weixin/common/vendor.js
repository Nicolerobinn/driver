...
var actions = {
  ...
  login: function login(_ref4, isAuthor) {var dispatch = _ref4.dispatch,commit = _ref4.commit;
    if (isAuthor) {
      uni.showToast({
        icon: "loading",
        title: '登陆中',
    ...
    uni.login({
      provider: 'weixin',
      success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var respones, _ref5, openid, session_key;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                  ...
                  commit('setToken', openid);case 7:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });
...
var install = function install(Vue, vm) {
  ...
  vm.$u.api = { getSearch: getSearch, getInfo: getInfo, getOpenId: getOpenId };
};var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.jscode2session = exports.location = exports.indexUrl = exports.hotSearchUrl = exports.BASE_URL = void 0;var BASE_URL = 'XXX';exports.BASE_URL = BASE_URL;
...
var jscode2session = 'https://api.weixin.qq.com/sns/jscode2session';exports.jscode2session = jscode2session;
