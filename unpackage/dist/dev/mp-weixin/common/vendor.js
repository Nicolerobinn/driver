...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var mutations = {
  ...
  setUserId: function setUserId(state, number) {
    state.userId = number;
  },
...
var install = function install(Vue, vm) {
  ...
  var saveQuestion = function saveQuestion(params) {return vm.$u.post("".concat(_http.saveQuestionUrl, "/").concat(params.id), params);};
