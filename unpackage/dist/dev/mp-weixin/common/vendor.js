...
var actions = {
  ...
  login: function login(_ref4, isAuthor) {var dispatch = _ref4.dispatch,commit = _ref4.commit,state = _ref4.state;
    ...
    uni.login({
      provider: 'weixin',
      success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var respones, _ref5, openid, session_key, myShareCode, tokenRes, _tokenRes$access_toke, access_token, codeRes, buffer, contentType;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                  ...
                  tokenRes.access_token, access_token = _tokenRes$access_toke === void 0 ? '' : _tokenRes$access_toke;_context.next = 14;return (
                    _main.default.$u.api.getGetwxacode({ access_token: access_token, path: "pages/my?shareCode=".concat(myShareCode) }));case 14:codeRes = _context.sent;
                  buffer = codeRes.buffer, contentType = codeRes.contentType;
                  console.log('buffer', buffer);
                  commit('setWXBuffer', buffer);
                  commit('setToken', openid);case 19:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });
...
var install = function install(Vue, vm) {
  ...
  var getAuth = function getAuth() {var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};return vm.$u.get(_http.auth, params);};
  ...
  vm.$u.api = { getSearch: getSearch, getInfo: getInfo, getOpenId: getOpenId, getWXToken: getWXToken, getGetwxacode: getGetwxacode, login: login, getAuth: getAuth };
};var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.auth = exports.getwxacode = exports.wxToken = exports.jscode2session = exports.location = exports.loginUrl = exports.indexUrl = exports.hotSearchUrl = exports.BASE_URL = void 0;var BASE_URL = 'XXX';exports.BASE_URL = BASE_URL;
...
exports.getwxacode = getwxacode;var auth = 'https://api.weixin.qq.com/sns/auth'; //获取小程序码
exports.auth = auth;
