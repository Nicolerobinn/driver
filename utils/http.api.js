import { hotSearchUrl,indexUrl,jscode2session ,wxToken,getwxacode ,loginUrl} from './http.url'
...
const install = (Vue, vm) => {
	...
	vm.$u.api = {getSearch, getInfo,getOpenId,getWXToken,getGetwxacode,login};
}
