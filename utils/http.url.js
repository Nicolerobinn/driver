export const BASE_URL='https://changpingwanglou.cn/cheguan'

export const loginUrl = 'user/login'
export const getQRcodeUrl = 'user/getCode'

export const imgSearchUrl = 'question/imgSearch'
export const getQuestionUrl = 'question/20Question'
